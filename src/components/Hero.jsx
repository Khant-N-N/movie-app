...
const Hero = () => {
  const { movies, loading } = useAxios(requests.requestPopular);
      ...
      {loading ? (
        ...
        <div className="h-[80vh] w-full relative">
          <div className="w-full h-full">
            <div className="w-full h-[80vh] absolute bg-gradient-to-r from-[var(--bg-color)]"></div>
          ...
          <div className="absolute top-[35%] md:top-[50%] left-[10%]">
            ...
            <div className="flex ml-4">
              <div className="my-2 flex border border-[var(--text-color)] rounded-[25px] px-4 py-2 cursor-pointer drop-shadow-[0_0_2px_black] hover:text-[var(--main-color)]">
